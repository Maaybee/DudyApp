    ...
    const modulesContent = {
        '1': {
            '1': [
                ...
                { id: '103', type: 'select_image', title: 'i eat', highlight: '...', correct: 'Banana', mascotImage: '../assets/svg/urso_banana.svg', options: [ { id: 'Banana', image: '../assets/svg/banana.svg', color: '#ffd1dc',  }, { id: 'apple', image: '../assets/svg/apple.svg', color: '#e9d5ff' } ]},
            ...
            '3': [
                { id: '112', type: 'select_image', title: 'Selecione', highlight: 'Uvas', correct: 'Grapes', options: [ { id: 'Grapes', image: '../assets/svg/grape.svg', color: '#ffd1dc' }, { id: 'sandwich', image: '../assets/svg/sandwich.svg', color: '#fff3e0' },{ id: 'cake', image: '../assets/svg/cake.svg', color: '#e9d5ff' },{ id: 'Orange', image: '../assets/svg/orange.svg', color: '#bae6fd' } ]},
